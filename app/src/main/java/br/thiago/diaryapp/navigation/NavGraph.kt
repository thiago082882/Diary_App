...
import br.thiago.diaryapp.presentation.screens.write.WriteScreen
import br.thiago.diaryapp.presentation.screens.write.WriteViewModel
import br.thiago.diaryapp.util.Constants
        ...
        DisplayAlertDialog(title = "Delete All Diaries",
            ...
            onYesClicked = {
                viewModel.deleteAllDiaries(onSuccess = {
                    Toast.makeText(
                        context, "All Diaries Deleted.", Toast.LENGTH_SHORT
                    ).show()
                    scope.launch {
                        drawerState.close()
                    }
