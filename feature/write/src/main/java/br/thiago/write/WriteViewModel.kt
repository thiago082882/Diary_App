...
import br.thiago.mongo.repository.MongoDB
import br.thiago.util.model.Diary
import br.thiago.util.model.Mood
import br.thiago.util.model.RequestState
import br.thiago.util.Constants.WRITE_SCREEN_ARGUMENT_KEY
import br.thiago.util.fetchImagesFromFirebase
import br.thiago.util.toRealmInstant
...
internal  class WriteViewModel @Inject constructor(
    ...
    val galleryState = br.thiago.ui.GalleryState()
    ...
    private fun fetchSelectedDiary() {
        if (uiState.selectedDiaryId != null) {
            Log.d("writeViewModel", "${uiState.selectedDiaryId}")
